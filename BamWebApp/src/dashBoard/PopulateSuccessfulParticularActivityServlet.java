...
@WebServlet("/populateParticularSuccessfulActivity")
public class PopulateSuccessfulParticularActivityServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (checkWebserviceOrDB.equalsIgnoreCase("Y")) {
			...
			String json = bam.populateSuccessfulActivityService(authTokenHtml,
					request, response);
